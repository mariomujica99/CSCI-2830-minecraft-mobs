...
The Minecraft Mobs Encyclopedia is a GUI application that provides information about mob creatures from the Minecraft universe. Users can browse through a comprehensive list of mobs, view detailed statistics, and behavior information. Sorting and filtering capabilities are available. The application uses object-oriented principles with JavaFX.
...
**Page of mob statistics, behavior, spawn locations, and description.**
...
**Mobs can be sorted by damage, health, and size for easy comparison.**
